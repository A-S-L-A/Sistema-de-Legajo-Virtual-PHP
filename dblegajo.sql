...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-07-2023 a las 02:18:36
...
CREATE TABLE `areas` (
  `IdArea` int(11) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `empleados` (
  ...
  `Estado` enum('Activo/a','Inactivo/a')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `empleados` (`DNI`,`Apellido`, `Nombre`, `FechaNacimiento`, `Telefono`, `IdProvincia`, `IdLocalidad`, `Domicilio`,`Estado`) VALUES
(1, 'Villalba', 'Sabrina', '1999-05-26', '456657', 23, 4300, 'Belgrano Sur ','Activo/a'),
(3, 'Guzman', 'Antonella', '1999-02-01', '5587745', 1, 1839, 'Escobar 125','Activo/a'),
(4, 'Gomez', 'Carla', '1999-05-21', '564654165465', 1, 2, 'mailin 22','Activo/a');
...
CREATE TABLE `estadocivil` (
  `IdCivil` int(11) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `licencia_estado` (
  `IdEstado` tinyint(4) PRIMARY KEY,
...
INSERT INTO `licencia_estado` (`IdEstado`,`Estado`) VALUES
('1','PENDIENTE'),
('2','AUTORIZADA'),
('3','RECHAZADA');
...
CREATE TABLE `familia` (
  `IdFamilia` int(11) PRIMARY KEY AUTO_INCREMENT,
...
CREATE TABLE `licencias` (
  `IdLicencia` int(11) PRIMARY KEY AUTO_INCREMENT,
  `IdEmpleado` int(10) NOT NULL,
...
INSERT INTO `licencias` (`IdEmpleado`, `IdTipoLicencia`, `Desde`, `Hasta`, `IdEstado`) VALUES
(1, 11, '2023-08-01', '2023-08-15', 1),
(3, 1, '2023-08-01', '2023-08-05', 1),
(2, 14, '2023-06-01', '2023-06-30', 1),
(2, 1, '2023-03-20', '2023-03-30', 2);
...
CREATE TABLE `localidades` (
  `IdLocalidad` int(11) PRIMARY KEY,
...
CREATE TABLE `provincias` (
  `IdProvincia` int(11) PRIMARY KEY,
...
--
-- Estructura de tabla para la tabla `tiposlicencia`
--

CREATE TABLE `tiposlicencia` (
  `IdTipoLicencia` int(11) PRIMARY KEY AUTO_INCREMENT,
  `Nombre` varchar(50) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Volcado de datos para la tabla `tiposlicencia`
--
...
INSERT INTO `usuarios` (`IdEmpleado`, `CorreoElectronico`, `Contraseña`, `rol`) VALUES
(1, 'Sabrina@gmail.com', 'sabry123', 'ADMIN'),
(2, 'Antonella@gmail.com', 'anto123', 'USER'),
(3, 'Carla@gmail.com', 'carla123', 'ADMIN');


--
ALTER TABLE `datoslaborales`
  ADD CONSTRAINT `datoslaborales_ibfk_1` FOREIGN KEY (`IdEmpleado`) REFERENCES `empleados` (`IdEmpleado`),
  ADD CONSTRAINT `datoslaborales_ibfk_2` FOREIGN KEY (`IdArea`) REFERENCES `areas` (`IdArea`),
  ADD CONSTRAINT `datoslaborales_ibfk_3` FOREIGN KEY (`IdCargo`) REFERENCES `cargos` (`IdCargo`),
  ADD CONSTRAINT `datoslaborales_ibfk_4` FOREIGN KEY (`IdCategoria`) REFERENCES `categorias` (`IDcategoria`);

--
-- Filtros para la tabla `empleados`
--
ALTER TABLE `empleados`
  ADD CONSTRAINT `empleados_ibfk_1` FOREIGN KEY (`IdProvincia`) REFERENCES `provincias` (`IdProvincia`),
  ADD CONSTRAINT `empleados_ibfk_2` FOREIGN KEY (`IdLocalidad`) REFERENCES `localidades` (`IdLocalidad`);

--
-- Filtros para la tabla `familia`
--
ALTER TABLE `familia`
  ADD CONSTRAINT `familia_ibfk_1` FOREIGN KEY (`IdEmpleado`) REFERENCES `empleados` (`IdEmpleado`),
  ADD CONSTRAINT `familia_ibfk_2` FOREIGN KEY (`IdCivil`) REFERENCES `estadocivil` (`IdCivil`);

--
-- Filtros para la tabla `licencias`
--
ALTER TABLE `licencias`
  ADD CONSTRAINT `licencias_ibfk_1` FOREIGN KEY (`IdEmpleado`) REFERENCES `empleados` (`IdEmpleado`),
  ADD CONSTRAINT `licencias_ibfk_2` FOREIGN KEY (`IdTipoLicencia`) REFERENCES `tiposlicencia` (`IdTipoLicencia`);
